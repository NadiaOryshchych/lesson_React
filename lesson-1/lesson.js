...
// фильтр - перебирает данные и выбирает нужные
...
// const res = Object.assign({}, user, admin); - перезаписывает объект user с новими значениями
// const res = Object.assign({}, user, admin); - создает новый пустой объект, все остальное тоже самое
...
//user.name.first;
const {name: {first, second}, pass, rigths} = user1;
